(self.webpackChunkeva_dav = self.webpackChunkeva_dav || []).push([
    [6975], {
        6975: function(t) {
            var e, n, i, o, r, s, a, u, l, d, h, p, c, m, f, g, v, M, w, y, b, T;
            T = [].slice, n = /^\(?([^)]*)\)?(?:(.)(d+))?$/, i = 1e3 / 30, m = document.createElement("div").style, s = null != m.transition || null != m.webkitTransition || null != m.mozTransition || null != m.oTransition, p = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, o = window.MutationObserver || window.WebKitMutationObserver || window.MozMutationObserver, u = function(t) {
                var e;
                ...
                return null == e && (e = 0), e ? (t *= Math.pow(10, e), (t = Math.floor(t += .5)) / Math.pow(10, e)) : Math.round(t)
            }, g = function(t) {
                ...
                if (!M && null != window.jQuery) {
                    for (M = !0, o = [], e = 0, n = (i = ["html", "text"]).length; e < n; e++) t = i[e], o.push(function(t) {
                        var e;
                ...
                function t(e) {
                    ...
                    null == (s = this.options).duration && (s.duration = 2e3), this.MAX_VALUES = this.options.duration / i / 2 | 0, this.resetFormat(), this.value = this.cleanValue(null != (d = this.options.value) ? d : ""), this.renderInside(), this.render();
                    try {
                        for (a = 0, u = (h = ["innerHTML", "innerText", "textContent"]).length; a < u; a++) o = h[a], null != this.el[o] && function(t) {
                ...
                return t.prototype.renderInside = function() {
                    ...
                    var t, e, i, o, r, s, a, u;
                    if ((t = null != (a = this.options.format) ? a : "(,ddd).dd") || (t = "d"), !(i = n.exec(t))) throw Error("Odometer: Unparsable digit format");
                    return s = (u = i.slice(1, 4))[0], r = u[1], o = (null != (e = u[2]) ? e.length : void 0) || 0, this.format = {
                        repeating: s,
                        radix: r,
                        precision: o
                    }
                    ...
                    if (e)
                        for (o = !1;;) {
                            if (!this.format.repeating.length) {
                                if (o) throw Error("Bad odometer format without digits");
                    ...
                    var e, n, i, o, r, s, u, l, d, h, p, c, m, f, v, M, w, y, b, T, E, x, S, D, L, C, F;
                    if (M = this.value, (l = this.getFractionalDigitCount(M, t)) && (t *= Math.pow(10, l), M *= Math.pow(10, l)), i = t - M) {
                        for (this.bindTransitionEnd(), o = this.getDigitCount(M, t), r = [], e = 0, p = b = 0; 0 <= o ? b < o : b > o; p = 0 <= o ? ++b : --b) {
                            if (w = g(M / Math.pow(10, o - p - 1)), u = g(t / Math.pow(10, o - p - 1)), Math.abs(s = u - w) > this.MAX_VALUES) {
                                for (h = [], c = s / (this.MAX_VALUES + this.MAX_VALUES * e * .5), n = w; s > 0 && n < u || s < 0 && n > u;) h.push(Math.round(n)), n += c;
                                h[h.length - 1] !== u && h.push(u), e++
                            } else h = function() {
                                F = [];
                                for (var t = w; w <= u ? t <= u : t >= u; w <= u ? t++ : t--) F.push(t);
                                return F
                            }.apply(this);
                            for (p = T = 0, x = h.length; T < x; p = ++T) d = h[p], h[p] = Math.abs(d % 10);
                            r.push(h)
                        }
                        for (this.resetDigits(), p = E = 0, S = (C = r.reverse()).length; E < S; p = ++E)
                            for (h = C[p], this.digits[p] || this.addDigit(" ", p >= l), null == (y = this.ribbons)[p] && (y[p] = this.digits[p].querySelector(".odometer-ribbon-inner")), this.ribbons[p].innerHTML = "", i < 0 && (h = h.reverse()), m = L = 0, D = h.length; L < D; m = ++L) d = h[m], (v = document.createElement("div")).className = "odometer-value", v.innerHTML = d, this.ribbons[p].appendChild(v), m === h.length - 1 && a(v, "odometer-last-value"), 0 === m && a(v, "odometer-first-value");
                        return w < 0 && this.addDigit("-"), null != (f = this.inside.querySelector(".odometer-radix-mark")) && f.parent.removeChild(f), l ? this.addSpacer(this.format.radix, this.digits[l - 1], "odometer-radix-mark") : void 0
                    }
                }, t
            }(), r.options = null != (y = window.odometerOptions) ? y : {}, setTimeout((function() {
                var t, e, n, i, o;
            ...
            }, null != (null != (b = document.documentElement) ? b.doScroll : void 0) && null != document.createEventObject ? (w = document.onreadystatechange, document.onreadystatechange = function() {
                return "complete" === document.readyState && !1 !== r.options.auto && r.init(), null != w ? w.apply(this, arguments) : void 0
            }) : document.addEventListener("DOMContentLoaded", (function() {
                if (!1 !== r.options.auto) return r.init()
            }), !1), void 0 === (e = r) || (t.exports = e)
        }
    }
]);